...
int main(int argc, char** argv) {
	...
	blip_set_rates(core->getAudioChannel(core, 0, NULL), GBA_ARM7TDMI_FREQUENCY, 0x8000);
	blip_set_rates(core->getAudioChannel(core, 1, NULL), GBA_ARM7TDMI_FREQUENCY, 0x8000);
...
static void _fuzzRunloop(struct mCore* core, int frames) {
	do {
		core->runFrame(core);
		--frames;
		blip_clear(core->getAudioChannel(core, 0, NULL));
		blip_clear(core->getAudioChannel(core, 1, NULL));
